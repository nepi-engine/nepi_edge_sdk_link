...
int main(int argc, char **argv)
{
  ...
  NEPI_EDGE_LBDataSnippetCreate(&data_snippets[0], "abc", 0); // Type and instance are required fields; hence in the Create method
  /* And populate some of the optional fields */
  NEPI_EDGE_LBDataSnippetSetDataTimestamp(data_snippets[0], "2020-08-21 09:50:25.6-04:00"); // 169ms after the status timestamp
  ...
  NEPI_EDGE_LBDataSnippetCreate(&data_snippets[1], "def", 55);
